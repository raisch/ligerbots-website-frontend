...
<!--   <ul class="flex w-1/2 -translate-y-20 gap-10 h-5 self-auto"> -->
    ...
    <!--     <img class="h-full w-full transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/images/first.svg" alt="first robotics" /> -->
    <!--   </a> -->
    <!-- </li> -->
    <!-- <li> -->
    <!--   <a class="object-center block overflow-contain w-full h-full" target="_blank" href="https://www.youtube.com/c/ligerbots"> -->
    <!--     <img class="object-contain w-[100%] h-[100%] transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/assets/e46d43c9-1e15-4e34-98a5-1bb9760ff078" alt="youtube" /> -->
    <!--   </a> -->
    <!-- </li> -->
    <!-- <li> -->
    <!--   <a class="block w-[100%] h-[100%]" target="_blank" href="https://x.com/ligerbots"> -->
    <!--     <img class="object-contain w-full h-full transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/assets/aaebd520-32cf-4c3e-bd31-9d8a5178ee05" alt="x" /> -->
    <!--   </a> -->
    <!-- </li> -->
    <!-- <li> -->
    <!--   <a class="block w-[100%] h-[100%]" target="_blank" href="https://www.facebook.com/The-LigerBots-162121450506644/"> -->
    <!--     <img class="w-full h-full object-contain transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/assets/a32f4f54-b323-45ee-a624-59276a135108" alt="facebook" /> -->
    <!--   </a> -->
    <!-- </li> -->
    <!-- <li> -->
    <!--   <a class="header-link w-[100%] h-[100%]" target="_blank" href="https://www.instagram.com/ligerbots_frc2877/"> -->
    <!--     <img class="w-full h-full object-contain transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/assets/3806f78a-68c5-4b0c-8f1d-9ac04481e94c" alt="instagram" /> -->
    <!--   </a> -->
    <!-- </li> -->
    <!-- <li> -->
    <!--   <a class="header-link object-right" target="_blank" href="https://www.flickr.com/photos/ligerbots/"> -->
    <!--     <img class="w-full h-full object-contain transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/assets/cf477ab4-9c50-417f-b8b7-a30a24e843d8" alt="flickr" /> -->
    <!--   </a> -->
    <!-- </li> -->
<!--     <li> -->
<!--       <!-- &nbsp;&nbsp; -->
<!--       <a class="header-link" href="/sponsor-us"> -->
<!--         <img class="w-full h-full object-contain transition delay-0 duration-200 ease-in-out hover:-translate-y-1 hover:scale-130" src="/assets//5bb9e371-74d4-4462-ae03-de76107749e7" alt="donate" /> -->
<!--       </a> -->
<!--     </li> -->
<!--   </ul> -->
<!-- </div> -->
