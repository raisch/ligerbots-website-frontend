...
<div class="rounded-[5px] border-1 border-[#939598] h-full shadow-[5px_5px_15px_-10px_rgba(0,0,0,25)] overflow-hidden w-full">
  ...
  <div class="overflow-auto h-full min-h-[900px] w-full">
    <div class="h-full flex w-full my-0 [&_*]:!w-full">
      <iframe id="fb-panel" src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fligerbots&amp;tabs=timeline&amp;width=600&amp;height=1000&amp;small_header=true&amp;adapt_container_width=true&amp;hide_cover=true&amp;show_facepile=false&amp;appId" width="100%" height="100%" style="border: none; overflow: hidden; width:100%; height: 100%;" scrolling="no" frameborder="0" allowfullscreen="true" allow="clipboard-write; encrypted-media; picture-in-picture; web-share" spellcheck="false" aria-label="To enrich screen reader interactions, please activate Accessibility in Grammarly extension settings" class="h-full"></iframe>
  </div>
