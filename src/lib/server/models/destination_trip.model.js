/** @module models/DestinationTripModel */
import Joi from 'joi'

// Auto-generated from schema.yaml for collection: destination_trip
export const DestinationTripModelSchema = Joi.object({
...
export default DestinationTripModelSchema
